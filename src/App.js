...
function App() {
  ...
  if (currentPage === 'classes') {
    const classes = [
      { id: 1, name: 'DIT 1A', program: 'DIT', students: 30, lecturer: 'Dr. Jane Smith', room: 'Lab A' },
      { id: 2, name: 'DIT 1B', program: 'DIT', students: 28, lecturer: 'Dr. John Doe', room: 'Lab B' },
      { id: 3, name: 'DBIT 2A', program: 'DBIT', students: 25, lecturer: 'Prof. Mary Johnson', room: 'Room 301' },
      { id: 4, name: 'BSc BIT 3A', program: 'BSc BIT', students: 22, lecturer: 'Dr. James Wilson', room: 'Room 405' }
    ];
  ...
  if (currentPage === 'monitoring') {
    const activities = [
      { id: 1, user: 'Dr. Jane Smith', action: 'Created Report', course: 'Database Management', time: '2 hours ago', type: 'create' },
      { id: 2, user: 'Prof. Michael Brown', action: 'Approved Report', course: 'Web Development', time: '3 hours ago', type: 'approve' },
      { id: 3, user: 'Dr. Sarah Johnson', action: 'Added Feedback', course: 'Software Engineering', time: '5 hours ago', type: 'feedback' },
      { id: 4, user: 'John Doe', action: 'Submitted Rating', course: 'Database Management', time: '1 day ago', type: 'rating' }
    ];
